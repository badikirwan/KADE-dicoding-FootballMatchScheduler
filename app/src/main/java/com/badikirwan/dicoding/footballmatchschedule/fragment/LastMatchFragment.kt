...
class LastMatchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        layout = inflater.inflate(R.layout.fragment_last_match, container, false)
        recyclerView = layout.findViewById(R.id.recycle_last_match)
        progressLoading = layout.findViewById(R.id.prog_last_match)
    ...
    fun loadData() {
        ...
        apiInterface.getPastMatch(LEAGUE_ID).enqueue(object : Callback<EventResponse> {
